...
@PropertySource(name = "com.company.testliquibase", value = "classpath:/com/company/testliquibase/module.properties")
public class TlConfiguration {

    @Bean("tl_TlViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.company.testliquibase"));
    ...
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.company.testliquibase"));
        return actions;
    }
}
